...
public class AudioRequest : MonoBehaviour
{
    ...
    public void PlayRemoteAudio(int userID, int numSom, int objType, Vector3 posSom, int selecaoQuad, int totaisQuad, int selecaoCirc, int totaisCirc, int feedB, int lastObjType, int lastFeedbackPressed)
    {
        // Compoe Mensagem
        ...
        string message = "Play:" + userID + ":" + numSom + ":" + objType + ":"
            ...
            + (int)(relativePos2.x * 1000) + ":" + (int)(relativePos2.y * 1000) + ":" + (int)(relativePos2.z * 1000) + ":" + selecaoQuad + ":" + totaisQuad + ":" + selecaoCirc + ":" + totaisCirc + ":" + feedB + ":" + lastObjType + ":" + lastFeedbackPressed;
